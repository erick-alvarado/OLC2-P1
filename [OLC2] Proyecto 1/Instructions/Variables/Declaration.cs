...
namespace _OLC2__Proyecto_1.Instructions.Variables
{
    class Declaration : Instruction
    {
        ...
        public Declaration(LinkedList<Access> id, Type_ type, int line, int column)
        {
            this.idList = id;
            this.type = type;
        ...
        public Declaration(LinkedList<Access> id, Type_ type, String id_, int line, int column)
        {
            this.idList = id;
            this.type = type;
            this.id = id_;
        ...
        public Declaration(LinkedList<Access> id, Type_ type, Expression value, int line, int column)
        {
            this.idList = id;
            this.type = type;
            this.value = value;
        ...
        public override object execute(Environment_ environment)
        {
            ...
            foreach(Access e in idList)
            {
                ...
                {
                    environment.saveVar(e.getId(), val.value, type);
                }
            }
            return null;
        }
